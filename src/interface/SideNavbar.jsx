              ...
              <ul class="space-y-2 font-medium">
                <li>
                  ...
                  >
                    ...
                    <span class="ms-3">Painel</span>
                  </a>
                </li>
                <li>
                  <a
                    href="#"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group opacity-20"
                  >
                    <svg
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">MVPs</span>
                ...
                <li>
                  ...
                  >
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Contas</span>
                    <span class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">
                      Em breve
                    </span>
                  </a>
                ...
                <li>
                  ...
                  >
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Guerra</span>
                    <span class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">
                      Em breve
                    </span>
                  </a>
